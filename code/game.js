...
//Load in sounds
var audio_coin = new Audio('coin.wav');
var audio_lose = new Audio('lose.wav');
var audio_jump = new Audio('jump.wav');
  ...
  var height = this.wrap.clientHeight;
    ...
    */
    ...
    if (center.x < left + margin)
      this.wrap.scrollLeft = lerp(this.wrap.scrollLeft,center.x - margin, camera_lerp) + random_range(-screen_shake,screen_shake);
    else if (center.x > right - margin)
      this.wrap.scrollLeft = lerp(this.wrap.scrollLeft,center.x + margin - width, camera_lerp) + random_range(-screen_shake,screen_shake);
    if (center.y < top + margin)
      this.wrap.scrollTop = lerp(this.wrap.scrollTop,center.y - margin, camera_lerp) + random_range(-screen_shake,screen_shake);
    else if (center.y > bottom - margin)
      this.wrap.scrollTop = lerp(this.wrap.scrollTop,center.y + margin - height, camera_lerp) + random_range(-screen_shake,screen_shake);

      screen_shake = screen_shake * 0.95;
  };
